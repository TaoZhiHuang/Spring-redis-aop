...
public class CacheUserAspect {
    ...
    public static final String POINTCUT_ADD="execution(* com.hzt.service.impl.UserServiceImpl.insert(..))";
    public static final String POINTCUT_UPDATE="execution(* com.hzt.service.impl.UserServiceImpl.updateByPrimaryKey(..))";
    public static final String POINTCUT_DELETE="execution(* com.hzt.service.impl.UserServiceImpl.deleteByPrimaryKey(..))";
    public static final String POINTCUT_GETONE="execution(* com.hzt.service.impl.UserServiceImpl.selectByPrimaryKey(..))";
